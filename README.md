...
- **Unresolved risks & open questions** — what the evidence couldn't answer
- **Consolidated sources** — cited references across all research stages
- **Disclaimers** — decision-support framing, not investment advice
...
A typical run completes in **3–5 minutes**.
...
├── tests/                    # 13 test modules, ~100% critical-path coverage
